...
export type BookFieldsFragment = {
  ...
  reservations: Array<{
    __typename?: 'Reservation';
    status: string;
    reserver: { __typename?: 'Member'; id: number };
  }>;
  loans: Array<{
    __typename?: 'Loan';
    status?: string | null;
    borrower: { __typename?: 'Member'; id: number };
  }>;
  author: { __typename?: 'Author'; id: number; name: string };
  tags: Array<{ __typename?: 'Tag'; id: number; name: string }>;
};

export type BasicBookFieldsFragment = {
  __typename?: 'Book';
  id: number;
  title: string;
  subtitle?: string | null;
...
export type LoanFieldsFragment = {
  __typename?: 'Loan';
  createdAt: any;
  id: number;
  returnDate: any;
  ...
  updatedAt: any;
  loanOverdue: boolean;
  lender: { __typename?: 'Member'; id: number };
  book: {
    __typename?: 'Book';
    id: number;
    title: string;
...
export type MessageFieldsFragment = {
  ...
  body: string;
  createdAt: any;
  sender: { __typename?: 'Member'; id: number; username: string };
};
...
export type Borrow_BookMutation = {
  __typename?: 'Mutation';
  borrow: {
    __typename?: 'BookResponse';
    message?: string | null;
...
export type LoginUserMutation = {
  ...
  login: {
    ...
    error?: Array<{ __typename?: 'FieldError'; message: string }> | null;
  };
};
...
export type Reserve_BookMutation = {
  __typename?: 'Mutation';
  reserve: {
    __typename?: 'BookResponse';
    message?: string | null;
    book?: {
      ...
      loans: Array<{
        __typename?: 'Loan';
        borrower: { __typename?: 'Member'; username: string };
      }>;
      reservations: Array<{
        __typename?: 'Reservation';
        status: string;
        reserver: { __typename?: 'Member'; username: string };
      }>;
    } | null;
  };
};
...
export type SendMessageMutation = {
  __typename?: 'Mutation';
  sendMessage: { __typename?: 'Message'; body: string; id: number };
};
...
export type GetBooksByOwnerQuery = {
  __typename?: 'Query';
  getBooksByOwner: Array<{
    __typename?: 'Book';
    id: number;
    title: string;
    subtitle?: string | null;
...
export type Get_Loans_By_IdQuery = {
  __typename?: 'Query';
  loansByLenderId: Array<{
    __typename?: 'Loan';
    createdAt: any;
    id: number;
    returnDate: any;
...
export type MessagesQuery = {
  ...
  messages: Array<{
    ...
    createdAt: any;
    body: string;
    conversation: { __typename?: 'Conversation'; id: number };
    sender: { __typename?: 'Member'; username: string; id: number };
  }>;
};
...
export const BasicBookFieldsFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
      name: { kind: 'Name', value: 'basicBookFields' },
      typeCondition: {
        kind: 'NamedType',
      ...
      selectionSet: {
        ...
        selections: [
          ...
          { kind: 'Field', name: { kind: 'Name', value: 'textSnippet' } },
...
} as unknown as DocumentNode<BasicBookFieldsFragment, unknown>;
...
export const LoanFieldsFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
      ...
      selectionSet: {
        ...
        selections: [
          ...
          { kind: 'Field', name: { kind: 'Name', value: 'loanOverdue' } }
        ]
      }
    },
    {
...
} as unknown as DocumentNode<LoanFieldsFragment, unknown>;
...
export const ReservationFieldsFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
      name: { kind: 'Name', value: 'reservationFields' },
      typeCondition: {
        kind: 'NamedType',
      ...
      selectionSet: {
        ...
        selections: [
          ...
          { kind: 'Field', name: { kind: 'Name', value: 'status' } },
          { kind: 'Field', name: { kind: 'Name', value: 'updatedAt' } },
          { kind: 'Field', name: { kind: 'Name', value: 'toBorrowDate' } }
        ]
      }
    },
    {
...
} as unknown as DocumentNode<ReservationFieldsFragment, unknown>;
      ...
      variableDefinitions: [
        {
          ...
          variable: {
            kind: 'Variable',
            name: { kind: 'Name', value: 'newBookData' }
          },
          type: {
            kind: 'NonNullType',
            type: {
              kind: 'NamedType',
              name: { kind: 'Name', value: 'NewBookInput' }
            }
          }
        }
      ],
...
export const Borrow_BookDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'BORROW_BOOK' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
            kind: 'Variable',
            name: { kind: 'Name', value: 'borrowId' }
          },
          type: {
            kind: 'NonNullType',
...
} as unknown as DocumentNode<Borrow_BookMutation, Borrow_BookMutationVariables>;
      ...
      variableDefinitions: [
        {
          ...
          variable: {
            kind: 'Variable',
            name: { kind: 'Name', value: 'createConversationData' }
          },
          type: {
            kind: 'NonNullType',
            type: {
              kind: 'NamedType',
              name: { kind: 'Name', value: 'conversationsInput' }
            }
          }
        }
      ],
...
export const ReadConversationDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'readConversation' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'markConversationAsRead' },
            arguments: [
              {
                kind: 'Argument',
                name: { kind: 'Name', value: 'conversationId' },
                ...
                { kind: 'Field', name: { kind: 'Name', value: 'id' } },
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: 'Field',
                        name: { kind: 'Name', value: 'hasSeenLatestMessage' }
                      },
                      {
                        kind: 'Field',
                        name: { kind: 'Name', value: 'updatedAt' }
      ...
      variableDefinitions: [
        {
          ...
          variable: {
            kind: 'Variable',
            name: { kind: 'Name', value: 'newMemberData' }
          },
          type: {
            kind: 'NonNullType',
            type: {
              kind: 'NamedType',
              name: { kind: 'Name', value: 'NewMemberInput' }
            }
          }
        }
      ],
...
export const Reserve_BookDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'RESERVE_BOOK' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
            kind: 'Variable',
            name: { kind: 'Name', value: 'reserveId' }
          },
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'Float' } }
  ...
  Reserve_BookMutation,
  Reserve_BookMutationVariables
>;
      ...
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: 'NamedType',
              name: { kind: 'Name', value: 'BookUpdateInput' }
            }
          }
        },
        {
...
export const GetBooksByOwnerDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'getBooksByOwner' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
  ...
  GetBooksByOwnerQuery,
  GetBooksByOwnerQueryVariables
>;
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GET_LOANS' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
...
} as unknown as DocumentNode<Get_LoansQuery, Get_LoansQueryVariables>;
export const Get_Loans_By_IdDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GET_LOANS_BY_ID' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
            kind: 'Variable',
            name: { kind: 'Name', value: 'lenderId' }
          },
          type: {
            kind: 'NonNullType',
            type: { kind: 'NamedType', name: { kind: 'Name', value: 'Float' } }
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'loansByLenderId' },
            arguments: [
              {
                kind: 'Argument',
                name: { kind: 'Name', value: 'lenderId' },
...
export const Get_Lender_ReservationsDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'reservationsByLenderId' },
            arguments: [
              {
                kind: 'Argument',
                name: { kind: 'Name', value: 'lenderId' },
  ...
  Get_Lender_ReservationsQueryVariables
>;
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'SEARCH_BOOKS' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'searchBook' },
            arguments: [
              {
                kind: 'Argument',
                name: { kind: 'Name', value: 'searchTerm' },
...
} as unknown as DocumentNode<Search_BooksQuery, Search_BooksQueryVariables>;
...
export const UpdatedConversationDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'subscription',
      name: { kind: 'Name', value: 'UpdatedConversation' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
